...
class ArsTechnicaFetcher(BaseNewsFetcher):
    """Fetcher for Ars Technica via RSS."""
    ...
    async def fetch(
        ...
        """Fetch articles from Ars Technica RSS."""
